  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        months: cn(
          "flex gap-4 flex-col md:flex-row relative overflow-visible",
          defaultClassNames.months
        ),
        month: cn("flex flex-col w-full gap-4 overflow-visible", defaultClassNames.month),
        nav: cn(
        ...
        dropdowns: cn(
          "w-full flex items-center text-sm font-medium justify-center h-(--cell-size) gap-1.5 z-20",
...
export { CalendarWithDropdowns, CalendarDayButton }