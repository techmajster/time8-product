...
import { POST, GET } from '@/app/api/cron/reconcile-subscriptions/route'
...
describe('ReconcileSubscriptionsJob', () => {
  ...
  describe('POST /api/cron/reconcile-subscriptions', () => {
    it('should require authorization', async () => {
      const request = new NextRequest('http://localhost:3000/api/cron/reconcile-subscriptions', {
        method: 'POST',
        headers: {
    ...
    it('should return success when no active subscriptions exist', async () => {
      const request = new NextRequest('http://localhost:3000/api/cron/reconcile-subscriptions', {
        method: 'POST',
        headers: {
          'authorization': 'Bearer test-secret'
      ...
      expect(data.message).toContain('No active subscriptions')
    })
  })
